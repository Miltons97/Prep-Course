...
function promedioResultadosTest(resultadosTest) {
  ...
  const promedios = resultadosTest.reduce ((acumulador,numero) => acumulador + numero,0)
...
function numeroMasGrande(numeros) {
  ...
  // Tu código:
const numeroMasGrande = Math.max.apply(null, numeros);
...
function mesesDelAño(array) {
  ...
  // Tu código:
    ...
    if(arrayContiene.includes("Enero") && arrayContiene.includes ("Marzo") && arrayContiene.includes("Noviembre")){
